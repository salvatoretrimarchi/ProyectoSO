...
% =======================================================
    ...
    % =====  CODE EDITOR =============
      \lstdefinestyle{CompilandoStyle} {                              %This is Code Style
        ...
        basicstyle          = \tiny\color{black},                   %Style of text
...
\begin{titlepage}
    ...
    \pagecolor{tealgreen}                                      %Make it this Color to page
    ...
    {\fontsize{36}{50}                                              %Size of the book
        \selectfont \textbf{Proyecto Final}}\\[0.5cm]       %Name of the book
    {\fontsize{36}{50}                                              %Size of the book
        \selectfont \textbf{Minibash}}\\[0.5cm]                %Name of the book
    \textcolor{BlueGrey100MD}                                        %Color or the topic
        {\textsc{\LARGE Sistemas Operativos}}     %Name of the general theme
    ...
    \LARGE \textsf{Erick Francisco Vázquez Nuñez}}   %Author

    % ===== MAKE SOME SPACE =========
    \vspace                                                         %Give some space
    \baselineskip                                                   %But we need this to up command
    
    {\large \textsf{Noviembre 2019}}                                  %Date
...
\section{Introducción}
    Shell script es un intérprete de comandos de UNIX, provee una interfaz entre el usuario
y el kernel para que se ocupen funciones del sistema.
...
\section{Desarrollo}
Bash realiza tres principales tareas \begin{itemize}
    \item Inicializar: en este paso, un shell típico leería y ejecutaría sus archivos de configuración. Estos cambian aspectos del comportamiento del shell.
    \item Interpretar: a continuación, el shell lee los comandos de stdin (que podría ser interactivo o un archivo) y los ejecuta.
    \item Terminar: después de ejecutar sus comandos, el shell ejecuta los comandos de apagado, libera memoria y finaliza.
\end{itemize}
...
\begin{itemize}
    ...
    \item Obtienes la cadena
    \item Dividimos la cadena de entrada en comandos
    \item Comprobamos si existen tuberías, direccionamiento a archivos, etc.
    \item Si hay tuberías hay que manejarlas.
    \item Ejecutamos los comandos del sistema llamando a execvp.
\end{itemize}
...
Generar este proyecto nos permitió ver como podemos usar funciones para llamar al sistema y manipular la visualización de la terminal para que tenga la apariencia que deseas.
    ...
    \begin{appendices}
    \lstinputlisting[language=C]{Code/bash.c}
